          ...
          <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
            ...
            {availableToAdd.length > 0 && (
              <button
                ...
                className="flex items-center self-center gap-1 sm:gap-1.5 px-2.5 sm:px-3 h-6 sm:h-7 rounded-md transition-opacity font-editorial-mono text-[9px] sm:text-[10px] font-bold tracking-wider"
