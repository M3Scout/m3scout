    ...
    <div className="space-y-5 pb-8 px-[var(--padding-mobile)] md:px-0">
      ...
      <div>
        <div className="flex items-center gap-3">
          ...
          <span className="inline-flex items-center justify-center min-w-[28px] h-6 px-2 rounded-full text-[13px] font-bold text-black bg-[#e63946]">{contracts.length}</span>
        </div>
      </div>
