...
const EditScoutingReport = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setValue("competitionId", report.competition_id);
      setValue("matchDate", report.match_date);
      setValue("opponent", report.opponent || "");
      setValue("matchNotes", report.match_notes || "");
      setValue("summary", report.summary || "");
      setValue("recommendation", report.recommendation || "");
      ...
      setCategoryNotes({
        ...
        mental: report.mental_notes || "",
        impact: report.impact_notes || "",
      });

      // Set modifiers
      setPotentialBonus(report.potential_bonus || 0);
      setConsistencyModifier(report.consistency_modifier || 0);
    ...
    fetchData();
  }, [id, navigate, setValue, setScores, setPotentialBonus, setConsistencyModifier]);
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <div>
        ...
        <h1 className="text-2xl md:text-3xl font-bold">Editar Relatório de Scouting</h1>
        <p className="text-muted-foreground">
          Atualize as informações e avaliações do atleta
        </p>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <Select 
                ...
                defaultValue={players.find(p => p.id)?.id}
              >
