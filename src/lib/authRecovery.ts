...
const FETCH_TIMEOUT_MS = 6000; // 6s per attempt — 3 retries + backoff stays under 20s watchdog
const RECOVERY_WATCHDOG_MS = 20000; // 20s watchdog — allow time for initial data-heavy loads
