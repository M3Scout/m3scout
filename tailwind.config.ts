  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "hero-pattern": "radial-gradient(ellipse at top, hsl(var(--primary) / 0.15) 0%, transparent 60%)",
        "card-gradient": "linear-gradient(135deg, hsl(var(--card) / 0.8), hsl(var(--background) / 0.6))",
      },
    },
  },
