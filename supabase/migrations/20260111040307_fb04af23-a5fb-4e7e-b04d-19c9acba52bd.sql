-- Update calculate_athlete_auto_rating to use new coefficient range (0.50-2.00) for competition level score
-- This aligns with the new tier thresholds
...
BEGIN
  ...
  LOOP
    ...
    -- V2: Final weight = year_weight * in_year_weight
