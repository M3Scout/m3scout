-- v21: usa apenas player_stats como fonte de dados
-- Remove UNION ALL com match_player_stats (src_live) que causava double counting
-- player_stats é a fonte autoritativa; todos os jogos devem ser consolidados antes do cálculo
...
BEGIN
  ...
  INSERT INTO public.player_attribute_scores (
    ...
    jsonb_build_object(
      ...
      'engine_version', 'v21',
      'data_source',   'player_stats only (no double counting)'
    ),
    now()
  );
