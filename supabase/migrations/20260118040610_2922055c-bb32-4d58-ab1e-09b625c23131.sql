-- Add aerial_duel_total to match_event_type enum
ALTER TYPE public.match_event_type ADD VALUE IF NOT EXISTS 'aerial_duel_total';

-- Update apply_event_stats to handle aerial_duel_total (aerial duel lost)
...
BEGIN
  ...
  CASE p_event_type
    ...
    -- Aerial duel total (lost): +1 aerial total, +1 duel total
