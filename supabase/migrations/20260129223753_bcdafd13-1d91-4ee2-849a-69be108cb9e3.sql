-- =============================================================================
-- Migration: Unify player stats (manual + live) for auto rating calculation
-- =============================================================================

-- Create a view that unifies stats from manual (player_stats) and live (match_player_stats) sources
