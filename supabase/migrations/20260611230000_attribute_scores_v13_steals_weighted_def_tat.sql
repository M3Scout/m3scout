-- calculate_player_attribute_scores v13
-- Separa steals (roubada de bola) de recoveries (recuperações).
-- Atualiza DEF e TAT com fórmulas ponderadas definidas pelo usuário (pesos somam 1.0).
...
BEGIN
  ...
  src_live AS (
    -- Dados ao vivo: steals = roubada de bola, recoveries = 0 (não rastreado separadamente)
    SELECT
  ...
  -- Eixo TÁTICA (TAT) — pressing, duelos, disciplina
  ...
  -- Eixo DEFESA (DEF) — ações defensivas diretas
...
-- Recalcula todos os scores com o motor v13
