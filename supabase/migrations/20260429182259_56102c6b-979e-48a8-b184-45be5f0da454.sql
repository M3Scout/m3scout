-- Apenas jogos APLICADOS contam nas estatísticas dos atletas.
-- Jogos com status 'finished' (Aguardando Aplicar) NÃO devem aparecer
-- nos totais até que o usuário clique em "Aplicar".

CREATE OR REPLACE VIEW public.unified_player_season_stats AS
