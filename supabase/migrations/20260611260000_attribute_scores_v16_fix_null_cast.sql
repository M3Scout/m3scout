-- calculate_player_attribute_scores v16
-- Corrige erro de UNION: NULL sem cast era inferido como TEXT pelo PostgreSQL.
-- NULL → NULL::bigint nos campos ausentes do live (long_passes_accurate,
-- long_passes_total, times_dribbled_past).
...
BEGIN
  ...
  src_live AS (
    -- Apenas partidas 'finished' — 'applied' já estão consolidadas em src_ps.
    -- Colunas ausentes no live: NULL::bigint para não poluir o SUM.
    SELECT
      ...
      NULL::bigint                                            AS times_dribbled_past,
...
-- Recalcula todos os scores com o motor v16
